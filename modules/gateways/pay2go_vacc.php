 ...
 * example file, the filename is "pay2go_vacc" and therefore all functions
 * begin "pay2go_vacc_".
 *
 ...
 * @return array
 */
function pay2go_vacc_MetaData() {
    return array(
        'DisplayName' => 'Pay2Go - 虛擬帳號',
...
function pay2go_vacc_link($params) {
