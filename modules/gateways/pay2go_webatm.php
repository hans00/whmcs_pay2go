 ...
 * example file, the filename is "pay2go_webatm" and therefore all functions
 * begin "pay2go_webatm_".
 *
 ...
 * @return array
 */
function pay2go_webatm_MetaData() {
    return array(
        'DisplayName' => 'Pay2Go - WebATM',
...
function pay2go_webatm_link($params) {
