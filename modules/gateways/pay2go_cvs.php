 ...
 * example file, the filename is "pay2go_cvs" and therefore all functions
 * begin "pay2go_cvs_".
 *
 ...
 * @return array
 */
function pay2go_cvs_MetaData() {
    return array(
        'DisplayName' => 'Pay2Go - 超商代碼',
...
function pay2go_cvs_link($params) {
